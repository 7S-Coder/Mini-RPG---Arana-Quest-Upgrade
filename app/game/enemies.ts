...
export const ENEMY_TEMPLATES: EnemyTemplate[] = [
  ...
  { templateId: "rat", name: "Rat géant", hp: 16, dmg: 5, def: 1, dodge: 3, crit: 1, speed: 26, rarity: 'common' },
  ...
  { templateId: "mushroom", name: "Champignon", hp: 26, dmg: 10, def: 2, dodge: 3, crit: 3, speed: 20, rarity: 'common' },
    // Rares
  ...
  { templateId: "pebble", name: "Caillou", hp: 28, dmg: 11, def: 3, dodge: 4, crit: 4, speed: 22, rarity: 'rare' },
  { templateId: "wish", name: "Sorcière", hp: 35, dmg: 12, def: 3, dodge: 1, crit: 2, speed: 16, rarity: 'rare' },
    // Épiques
  ...
  { templateId: "troll_cavernes", name: "Troll des cavernes", hp: 70, dmg: 20, def: 9, dodge: 2, crit: 2, speed: 12, rarity: 'legendary' },
  { templateId: "hydre", name: "Hydre", hp: 80, dmg: 22, def: 10, dodge: 5, crit: 5, speed: 16, rarity: 'legendary' },
  { templateId: "chimere", name: "Chimère", hp: 90, dmg: 25, def: 11, dodge: 7, crit: 7, speed: 20, rarity: 'legendary' },
    // Mythiques
  { templateId: "seigneur", name: "Seigneur du Fléau", hp: 120, dmg: 28, def: 10, dodge: 6, crit: 8, speed: 24, rarity: 'mythic' },
  { templateId: "dragon", name: "Dragon Ancien", hp: 150, dmg: 32, def: 12, dodge: 8, crit: 10, speed: 30, rarity: 'mythic' },
  { templateId: "phoenix", name: "Phénix Légendaire", hp: 175, dmg: 43, def: 11, dodge: 10, crit: 45, speed: 28, rarity: 'mythic' },
  { templateId: "leviathan", name: "Léviathan", hp: 200, dmg: 50, def: 15, dodge: 12, crit: 12, speed: 20, rarity: 'mythic' },
];
