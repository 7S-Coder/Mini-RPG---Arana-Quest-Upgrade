...
export const ENEMY_TEMPLATES: EnemyTemplate[] = [
  ...
  { templateId: "stone_golem", name: "Stone Golem", hp: 56, dmg: 16, def: 12, dodge: 5, crit: 8, speed: 10, rarity: 'uncommon' },
  { templateId: "crystal_bug", name: "Crystal Bug", hp: 42, dmg: 15, def: 7, dodge: 7, crit: 11, speed: 15, rarity: 'uncommon' },
  { templateId: "cave_troll", name: "Cave Troll", hp: 60, dmg: 18, def: 10, dodge: 6, crit: 10, speed: 12, rarity: 'uncommon' },
  ...
  { templateId: "bat", name: "Bat", hp: 32, dmg: 10, def: 4, dodge: 6, crit: 12, speed: 18, rarity: 'rare' },
  { templateId: "snail", name: "Snail", hp: 40, dmg: 12, def: 8, dodge: 4, crit: 8, speed: 8, rarity: 'rare' },
  ...
  { templateId: "tomb_guardian", name: "Tomb Guardian", hp: 50, dmg: 18, def: 14, dodge: 8, crit: 12, speed: 12, rarity: 'epic' },
  { templateId: "ghost_knight", name: "Ghost Knight", hp: 48, dmg: 20, def: 12, dodge: 10, crit: 14, speed: 14, rarity: 'epic' },
  { templateId: "cursed_statue", name: "Cursed Statue", hp: 54, dmg: 16, def: 16, dodge: 6, crit: 10, speed: 10, rarity: 'epic' },
