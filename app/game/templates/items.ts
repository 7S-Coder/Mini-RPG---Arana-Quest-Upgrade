...
export const ITEM_POOL: ItemTemplate[] = [
  ...
  { slot: "hat", name: "Helmet in Inns", category: "armor", stats: { hp: 4, def: 5, resolve: 1 }, weight: 4, rarity: "rare", allowedMaps: ["forest", "caves", "ruins", "volcano"], description: "Nights in inns are worse than battles." },
  ...
  { slot: "boots", name: "Dodge Shoes", category: "armor", stats: { dodge: 6, speed: 4 }, weight: 3, rarity: "rare", allowedMaps: ["forest", "caves", "ruins", "volcano"], description: "Staying alive is nothing to be proud of." },
  ...
  { slot: "chestplate", name: "Male ferret", category: "armor", stats: { hp: 18, def: 14,resolve: 5 }, weight: 6, rarity: "legendary", allowedMaps: ["ruins", "volcano"], description: "The sound of metal against the world." },
